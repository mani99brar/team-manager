...
| `freeze-interrupted.json` | controller | the cause of a freeze Claude Code's unavailability interrupted; the next `automatic --live` removes it and re-enters the freeze once |
